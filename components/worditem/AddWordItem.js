...
export default function AddWordItem({ setAdd, data, setData }) {
  ...
  return (
    <div
      className={`item w-full h-28 overflow-hidden mb-2 rounded-lg cursor-pointer border-2 border-gray-300 shadow hover:shadow-lg transition ease-in-out duration-300 px-4 select-none mobile:h-72 ${
